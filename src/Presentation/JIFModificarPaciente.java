 ...
 * @author Bryyv
 */
public class JIFModificarPaciente extends javax.swing.JInternalFrame {
    funciones cnn = new funciones();

    /**
     * Creates new form JIFModificarPaciente
     */
    public JIFModificarPaciente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(133, 25));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(dtchFnacimiento, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 306, Short.MAX_VALUE)
    ...
    public void modificar_paciente() {
        try {
            ...
            objPaciente.setTelefono("074" + txtTelefono1.getText() + txtTelefono2.getText() + txtTelefono3.getText());
            ...
            if (objPaciente.modificar() == true) {
                JOptionPane.showMessageDialog(rootPane, "Paciente modificado con éxito");
            }else {
                JOptionPane.showMessageDialog(rootPane, "No se pudo modificar Paciente");
            }
        } catch (Exception ex) {
    ...
    static String historia_n = "";
    
    public void consultar_n_historia(String dni) {
        try {
            String sql = "SELECT historia_clinica.n_historia FROM paciente INNER JOIN historia_clinica ON "
                    + "historia_clinica.dni_paciente = paciente.dni WHERE paciente.dni = '" + dni + "'";
            PreparedStatement ps = cnn.getCnn().prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                historia_n = rs.getString(1);
            }
        } catch (Exception e) {
    ...
    public static com.toedter.calendar.JDateChooser dtchFnacimiento;
    ...
    public static javax.swing.JTextField txtCel11;
    public static javax.swing.JTextField txtCel12;
    public static javax.swing.JTextField txtCel13;
    public static javax.swing.JTextField txtCel21;
    public static javax.swing.JTextField txtCel22;
    public static javax.swing.JTextField txtCel23;
